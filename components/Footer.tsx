        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm text-white/60">
          ...
          <div className="mb-6 flex justify-center gap-4">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-white/60 transition-all hover:border-pink-400/50 hover:bg-pink-500/10 hover:text-pink-300"
            >
            ...
            <a
              href="https://www.facebook.com/colorcocktailfactory"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Follow us on Facebook"
              className="flex h-10 w-10 items-center justify-center rounded-full border border-white/15 bg-white/5 text-white/60 transition-all hover:border-blue-400/50 hover:bg-blue-500/10 hover:text-blue-300"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
